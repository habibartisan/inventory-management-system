                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{route('pos')}}" class="waves-effect"><i class="fa fa-user-plus"></i><span> POS</span><span class="pull-right"><i class="md md-add"></i></span></a>
                            </li>
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="{{route('seccessorder')}}">Success Orders</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="{{ route('previous.yearly.expense') }}">Previous Year Expense</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-user-plus"></i><span> Employee</span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('addv.advancedsalary') }}">Add Advanced Salary</a></li>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-palette"></i> <span>My Company</span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('setting') }}">Add Information</a></li>
                                    <li><a href="{{ route('show') }}">Show Information</a></li>
