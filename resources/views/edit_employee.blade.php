                ...
                <div class="col-md-8" style="margin-left: 150px">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" action="{{route('update.employee',$edit->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="experience" value="{{ $edit->experience }}" class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Nid_no</label>
                                    <div class="col-sm-9">
                                        <input type="number" name="nid_no" value="{{ $edit->nid_no }}" class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Salary</label>
                                    <div class="col-sm-9">
                                        <input type="number" name="salary" value="{{ $edit->salary }}" class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Vacation</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="vacation" value="{{ $edit->vacation }}" class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="form-group">
