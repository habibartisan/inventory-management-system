...
class CustomerController extends Controller
{
    ...
    public function customer()
    {
        ...
        return view('all_customers',compact('customer'));
    }

    public function viewcustomer($id)
    {
        $singledata=DB::table('customers')
            ->where('id',$id)
            ->first();
        return view('view_customers', compact('singledata'));
    }

    //Customers Delete Here
    public function deletecustomer($id)
    {
        ...
        return view('edit_customers', compact('edit'));
        }


        //Customers Update Here
